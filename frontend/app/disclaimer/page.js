    ...
    <div className="section" style={{ paddingTop: '8rem' }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', opacity: 0.9 }}>
          ...
          <p>
            If you have any questions about this Disclaimer, please contact us at: <a href="mailto:pastor@unionchurch.in" style={{ color: 'var(--color-primary)' }}>pastor@unionchurch.in</a> or <a href="mailto:secretary@unionchurch.in" style={{ color: 'var(--color-primary)' }}>secretary@unionchurch.in</a>
          </p>
        </div>
      </div>
    </div>
