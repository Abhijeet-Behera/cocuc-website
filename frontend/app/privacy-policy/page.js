      ...
      <div className="container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', opacity: 0.9 }}>
          ...
          <p>
            ...
            Email: <a href="mailto:pastor@unionchurch.in" style={{ color: 'var(--color-primary)' }}>pastor@unionchurch.in</a> or <a href="mailto:secretary@unionchurch.in" style={{ color: 'var(--color-primary)' }}>secretary@unionchurch.in</a>
          </p>
        </div>
      </div>
    </div>
