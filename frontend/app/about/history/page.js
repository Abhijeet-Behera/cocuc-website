    ...
    <div>
      <section style={{ backgroundColor: 'var(--color-primary-dark)', color: 'var(--color-white)', padding: '150px 0 100px 0', textAlign: 'center' }}>
        <div className="container">
          <h1 style={{ fontSize: '3.5rem', marginBottom: '1rem' }}>Our History</h1>
          <p style={{ fontSize: '1.25rem', opacity: 0.9, maxWidth: '600px', margin: '0 auto' }}>
            The journey of Church of Christ (Union Church), Bhubaneswar
          </p>
        </div>
      </section>
      ...
      <section className="section container">
        <div style={{ maxWidth: '900px', margin: '0 auto', backgroundColor: 'var(--color-white)', padding: '3rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ fontSize: '1.1rem', color: 'var(--color-text-muted)', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <p>
              The continuous efforts of the committee paid off when the government provided the long awaited piece of land for construction of the church. It was decided to first construct the Pastor’s quarter as it would incur less expenditure and would temporarily be used as the place of worship and to conduct the Sunday School there till enough funds could be raised to construct the main Church building. The foundation stone of the Church was laid amidst prayers offered by the members of the congregation on December 17, 1960. Meanwhile, the Pastor’s quarter was completed and it was dedicated to the Lord on September 24, 1961. As the construction of the Church building began, Christian families contributed one to two month’s income in instalments to speed up the work. The work was completed and the worshippers gathered together to thank and praise the Lord on March 8, 1964 at the dedication ceremony.
            </p>
            <p>
              The new church building was then used for the worship and two months later an English worship service in the morning was added to the schedule which is continuing today. The Pastor Rev. Simeon Sahu left in 1958 and the Church was without a Pastor for nine years subsequently. The eminent servant of the Lord, Rev. Subodh Sahu joined the Church as its honorary Pastor in January 1967 for four years. During his tenure, Rev. Sahu took the leadership in organizing the first All Odisha Pastors’ Conference in January 1968. It was attended by over 700 delegates from different districts. Rev. Sahu also took the lead in organizing a fellowship in 1968 for the young people. It included Bible Study lessons to help them grow in their spiritual life. A youth fellowship under the banner of Christian Endeavour Union was launched in the Church in 1972 and it continued to grow under the leadership of Dr. Bidyut Kumar Pramanik, a senior government official who was the General Secretary of the India Christian Endeavour Union at that time. The Christian Endeavour turned out to be an asset for the Church with its members helping and participating in spiritual programs and excelling in social service as well. The decade of the 1970s was a golden period for the youth of the Church.
            </p>
            <p>
              Subsequently, a worship centre was established in the Chandrasekharpur area in a rented house as the city began to expand in all directions. It is still being conducted there in a rented building where worship in Odia is held every Sunday morning preceded by Sunday School classes.
            </p>
            <p>
              The Pastors who served the Church included Rev. Simeon Sahu, Rev. Subodh Sahu, Rev. Sadananda Patra, Rev. Saroj Sahoo, Rev. Juria Bardhan, Rev. P.Niranjan James and Rev. David Rout. Rev. Manmohan Das and Rev. Bibhuti Kumar Nayak also served the Church as Associate Pastors for short spells while Rev. Ayub Chhinchani, who joined the Church as Evangelist and later served as Assistant Pastor, is the only minister serving the congregation now as Associate Pastor. Two of the Church Elders, Rev. Alin Kumar Rout and Rev. Nithaniel Supakar, were ordained by the Church to assist in the Pastoral ministry. Rev. Rout passed away last year after which the congregation chose Mr. Stephen Behera to replace late Rout. Mr. Behera was subsequently ordained for the purpose.
            </p>
            <p>
